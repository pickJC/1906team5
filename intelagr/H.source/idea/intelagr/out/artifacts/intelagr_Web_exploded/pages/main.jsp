    ...
    <ul id="menu_tree">
		<li class="menuTitleLi">
			...
			<ul>
				...
				<li iconCls="icon-add"><span><a onClick="addTab('个人信息维护','user/basicInfoEdit.html')">个人信息维护</a></span></li>
		...
		<li class="menuTitleLi">
			...
			<ul>
				...
				<li iconCls=""><span><a onClick="addTab('普通土地备案申请','genelandreg/geneLandRegEdit.html')">普通土地备案申请</a></span></li>

				<li iconCls=""><span><a onClick="addTab('普通土地备案一览','genelandreg/geneLandRegList.html')">普通土地备案一览</a></span></li>

				<li iconCls=""><span><a onClick="addTab('特殊土地备案申请','speclandreg/specLandRegEdit.html')">特殊土地备案申请</a></span></li>

				<li iconCls=""><span><a onClick="addTab('特殊土地备案一览','speclandreg/specLandRegList.html')">特殊土地备案一览</a></span></li>

				<li iconCls=""><span><a onClick="addTab('特殊土地备案审核','speclandreg/specLandRegListQuery.html')">特殊土地备案审核</a></span></li>

				<li iconCls=""><span><a onClick="addTab('土地备案变更申请','landchange/landChangeEdit.html')">土地备案变更申请</a></span></li>

				<li iconCls=""><span><a onClick="addTab('土地备案变更申请一览','landchange/landChangeList.html')">土地备案变更申请一览</a></span></li>

				<li iconCls=""><span><a onClick="addTab('土地备案变更处理','landchange/landChangeListQuery.html')">土地备案变更处理</a></span></li>
		...
		<li class="menuTitleLi">
			...
			<ul>
				...
				<li iconCls=""><span><a onClick="addTab('水质监测数据管理','watermoni/waterMoniList.html')">水质监测数据管理</a></span></li>

				<li iconCls=""><span><a onClick="addTab('土壤监测数据管理','soilmoni/soilMoniList.html')">土壤监测数据管理</a></span></li>

				<li iconCls=""><span><a onClick="addTab('PM2.5监测数据采集','pmmoni/pmMoniList.html')">PM2.5监测数据采集</a></span></li>
		...
		<li class="menuTitleLi">
			...
			<ul>
				...
				<li iconCls=""><span><a onClick="addTab('收粮预报统计','graireg/graiForeListQuery.html')">收粮预报统计</a></span></li>
		...
		<li class="menuTitleLi">
			...
			<ul>
				...
				<li iconCls=""><span><a onClick="addTab('过程监控资料管理','procmoni/procMoniEdit.html')">过程监控资料管理</a></span></li>
		...
		<li class="menuTitleLi">
			...
			<ul>
				...
				<li iconCls=""><span><a onClick="addTab('种源评估参数维护','proveval/provEvalList.html')">种源评估参数维护</a></span></li>

				<li iconCls=""><span><a onClick="addTab('种源产量评估管理','proveval/provEvalListQuery.html')">种源产量评估管理</a></span></li>

				<li iconCls=""><span><a onClick="addTab('粮食评估参数维护','graieval/graiEvalList.html')">粮食评估参数维护</a></span></li>

				<li iconCls=""><span><a onClick="addTab('粮食产量评估管理','graieval/graiEvalListQuery.html')">粮食产量评估管理</a></span></li>
		...
		<li class="menuTitleLi">
			...
			<ul>
				...
				<li iconCls=""><span><a onClick="addTab('企业产量预报','yieldpredict/yieldPredictReg.html')">企业产量预报</a></span></li>

				<li iconCls=""><span><a onClick="addTab('企业产量预报一览','yieldpredict/yieldPredictList.html')">企业产量预报一览</a></span></li>

				<li iconCls=""><span><a onClick="addTab('企业产量预报分析','tmp')">企业产量预报分析</a></span></li>

				<li iconCls=""><span><a onClick="addTab('企业防伪码申请记录','securitycode/applyList.html')">企业防伪码申请记录</a></span></li>
		...
		<li class="menuTitleLi">
			...
			<ul>
				...
				<li iconCls=""><span><a onClick="addTab('企业投诉登记','companycplt/companyCPLTEdit.html')">企业投诉登记</a></span></li>

				<li iconCls=""><span><a onClick="addTab('企业投诉处理','companycplt/companyCPLTList.html')">企业投诉处理</a></span></li>

				<li iconCls=""><span><a onClick="addTab('种子公司投诉登记','seedcplt/seedCPLTEdit.html')">种子公司投诉登记</a></span></li>

				<li iconCls=""><span><a onClick="addTab('种子公司投诉处理','seedcplt/seedCPLTList.html')">种子公司投诉处理</a></span></li>
